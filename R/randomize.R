...
#'
#' Note that the above is not an implementation of differential privacy and
#' that, when groups are defined, information both *within and between* grouping
