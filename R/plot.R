...
add_covid_events <- function(gg_obj, lab_y, ...) {
  gg_obj %>%
    ...
    add_event("2021-06-12", "Masks Mandatory in Local/State & Federal Building/Public Transportation", lab_y = lab_y, ...) %>%
    add_event("2021-07-10", "Mask Recomendations for Unvaccinated in Public, Private, and Outdoor Settings", lab_y = lab_y, ...) %>%
